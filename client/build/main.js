...
(function (window, document, undefined) {
  ...
  function minErr(module) {
    return function () {
      ...
      message = message + '\nhttp://errors.angularjs.org/1.2.13-build.2240+sha.5218c7b/' + (module ? module + '/' : '') + code;
  ...
  var version = {
      full: '1.2.13-build.2240+sha.5218c7b',
      major: 1,
      minor: 2,
      dot: 13,
      codeName: 'snapshot'
...
define('grapevine/index',['require','exports','module','angular'],function (require, exports, module) {
...
define('main',['require','exports','module','angular','./grapevine/index'],function (require, exports, module) {
  var angular = require('angular');
  angular.element(document).ready(function () {
    angular.bootstrap(document, [require('./grapevine/index').name]);
  });
});
require(["main"]);
}());